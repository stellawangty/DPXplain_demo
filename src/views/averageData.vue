  ...
  <div class="containerBox">
    <div class="selectBox_">
      ...
      <el-select v-model="value" placeholder="Adult">
        <el-option
    ...
    <div class="container_search" style="margin-top:20px">
      <div style="text-align:left">Please enter query below:</div>
      <div style="text-align:left; color: #ccc">Current table is 
        <span v-if="value">{{ value }}</span>
        <span v-else>Adult</span>
      </div>
      ...
      <!-- <div class="searchBox">
          ...
          <div class="selectBox1" style="position:relative;display:inline-block">
           ...
           <el-select v-model="search1" placeholder="Profile">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
         ...
         <el-select v-model="search2" placeholder="Profile">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
          ...
          GROUPBY
          <div class="selectBox1" style="position:relative;display:inline-block">
            <el-select v-model="search3" placeholder="Profile">
              <el-option
                v-for="item in options"
                :key="item.value"
                :label="item.label"
    ...
    <div class="container">
      <el-table border :data="resultData" style="width: 100%; font-size: 17px">
        <el-table-column prop="Tuple_id" label="Tuple_id" width="180">
        </el-table-column>
        <el-table-column prop="marital_status" label="marital_status">
        </el-table-column>
        <el-table-column prop="occupation" label="occupation">
        </el-table-column>
        <el-table-column sortable prop="education" label="education">
        </el-table-column>
        <el-table-column sortable prop="high_income" label="high_income">
        </el-table-column>
      </el-table>
      <div class="rightBox">
        <div>
        ...
        <div>
          <el-button
            ...
            type="primary"
            @click="rangeRandom(1, 5)"
            >Choose a budget for me</el-button
          >
          <span style="display: inline-block" v-if="chooseNum !== ''">{{
            chooseNum
          }}</span>
          <span style="display: inline-block" v-else>privacy budget</span>
          <br />
    ...
    >
      <div>
        ...
        <div class="right">
          <div>
            SELECT <el-input v-model="dia.search1"></el-input>AS<el-input
              class="AS"
              v-model="dia.search2"
            ></el-input>
          </div>
          <div>
            FROM <el-input v-model="dia.search3"></el-input>AS<el-input
              class="AS"
              v-model="dia.search4"
            ></el-input>
          </div>
